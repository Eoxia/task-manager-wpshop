...
<hr />
<p><?php esc_html_e( 'This message below is only visible by you', 'task-manager-wpshop' ); ?></p>

<h2>
	<?php esc_html_e( 'You have been notified by', 'task-manager-wpshop' ); ?>&nbsp;
	<span><?php echo esc_html( $current_user->user_email ); ?></span>&nbsp;
	<?php esc_html_e( 'for the task', 'task-manager-wpshop' ); ?>&nbsp;
	<a href="<?php echo esc_attr( admin_url( 'admin.php?page=wpeomtm-dashboard&term=' . $task->data['id'] ) ); ?>">#<?php echo esc_html( $task->data['id'] ); ?></a>&nbsp;
	<?php esc_html_e( 'for the customer', 'task-manager-wpshop' ); ?>&nbsp;
	<a href="<?php echo esc_attr( admin_url( 'post.php?action=edit&post=' . $task->data['parent_id'] ) ); ?>"><?php echo esc_html( $task->data['title'] ); ?></a>
</h2>

<p><?php esc_html_e( 'This message above is only visible by you', 'task-manager-wpshop' ); ?></p>
<hr />
