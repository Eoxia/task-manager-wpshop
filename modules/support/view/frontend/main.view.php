	...
	<div class="wpeo-window-ask-task-container">
		...
		<div id="wpeo-window-ask-task" >
			<form class="form" action="<?php echo esc_attr( admin_url( 'admin-ajax.php' ) ); ?>" method="POST">
				...
				<input type="button" data-loader="form" class="action-input" data-parent="form" data-nonce="<?php echo esc_attr( wp_create_nonce( 'ask_task' ) ); ?>" value="<?php esc_html_e( 'Confirm', 'task-manager' ); ?>">
			</form>
		</div>
	</div>
